...
const STRINGS := {
	"no": {
		...
		"settings.credits": "MUSIKK: «MESMERIZING GALAXY» OG «ENVISION» AV KEVIN MACLEOD (INCOMPETECH.COM), CC BY 4.0\nLYD OG PARTIKLER: KENNEY.NL, CC0",
		"settings.on": "PÅ",
		"settings.off": "AV",
		"settings.level.0": "AV",
	...
	"en": {
		...
		"settings.back": "BACK",
		"settings.credits": "MUSIC: «MESMERIZING GALAXY» AND «ENVISION» BY KEVIN MACLEOD (INCOMPETECH.COM), CC BY 4.0\nSOUNDS AND PARTICLES: KENNEY.NL, CC0",
		"settings.on": "ON",
		"settings.off": "OFF",
